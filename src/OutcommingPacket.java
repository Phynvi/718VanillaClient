...
public class OutcommingPacket {
	public static OutcommingPacket ACTION_BUTTON_5_PACKET;
	public static OutcommingPacket KEY_PRESSED_PACKET;
	...
	public static OutcommingPacket ACTION_BUTTON_1_PACKET;
	...
	public static OutcommingPacket OBJECT_CLICK_5_PACKET;
	...
	public static OutcommingPacket DEVELOPER_CONSOLE_PACKET;
	...
	public static OutcommingPacket NPC_CLICK_3_PACKET;
	public static OutcommingPacket aClass198_2032;
	public static OutcommingPacket OBJECT_CLICK_3_PACKET;
	public static OutcommingPacket aClass198_2034;
	public static OutcommingPacket KICK_CLAN_CHAT_PACKET;
	...
	public static OutcommingPacket PLAYER_OPTION_2_PACKET;
	public static OutcommingPacket aClass198_2040;
	public static OutcommingPacket ENTER_LONG_TEXT_PACKET;
	public static OutcommingPacket PLAYER_OPTION_6_PACKET;
	public static OutcommingPacket PLAYER_OPTION_1_PACKET;
	...
	public static OutcommingPacket ACTION_BUTTON_4_PACKET;
	public static OutcommingPacket PLAYER_OPTION_9_PACKET;
	public static OutcommingPacket aClass198_2050;
	public static OutcommingPacket MINI_WALKING_PACKET;
	public static OutcommingPacket OBJECT_CLICK_2_PACKET;
	public static OutcommingPacket LOBBY_FRIEND_CHAT_SETTINGS;
	public static OutcommingPacket aClass198_2054;
	public static OutcommingPacket aClass198_2055;
	public static OutcommingPacket PLAYER_OPTION_7_PACKET;
	public static OutcommingPacket GRAND_EXCHANGE_ITEM_SELECT;
	public static OutcommingPacket NPC_EXAMINE_PACKET;
	public static OutcommingPacket aClass198_2059;
	public static OutcommingPacket ACTION_BUTTON_2_PACKET;
	public static OutcommingPacket REMOVE_IGNORE_PACKET;
	public static OutcommingPacket aClass198_2062;
	public static OutcommingPacket WINDOW_FOCUS_PACKET;
	...
	public static OutcommingPacket PLAYER_OPTION_5_PACKET;
	public static OutcommingPacket WORLD_LIST_UPDATE;
	public static OutcommingPacket aClass198_2072;
	public static OutcommingPacket aClass198_2073;
	public static OutcommingPacket ENTER_INTEGER_PACKET;
	public static OutcommingPacket WALKING_PACKET;
	public static OutcommingPacket CHAT_TYPE_PACKET;
	public static OutcommingPacket NPC_CLICK_4_PACKET;
	...
	public static OutcommingPacket ACTION_BUTTON_6_PACKET;
	public static OutcommingPacket LOBBY_MAIN_CLICK_PACKET;
	...
	public static OutcommingPacket ACTION_BUTTON_10_PACKET;
	...
	public static OutcommingPacket NPC_CLICK_2_PACKET;
	...
	static {
		KEY_PRESSED_PACKET = new OutcommingPacket(1, -2);
		...
		ACTION_BUTTON_1_PACKET = new OutcommingPacket(14, 8);
		...
		NPC_CLICK_3_PACKET = new OutcommingPacket(34, 3);
		...
		OBJECT_CLICK_3_PACKET = new OutcommingPacket(40, 9);
		aClass198_2034 = new OutcommingPacket(41, -1);
		PLAYER_OPTION_1_PACKET = new OutcommingPacket(42, 3);
		aClass198_2050 = new OutcommingPacket(43, 7);
		aClass198_2037 = new OutcommingPacket(44, -2);
		aClass198_2038 = new OutcommingPacket(45, 7);
		PLAYER_OPTION_2_PACKET = new OutcommingPacket(46, 3);
		aClass198_2040 = new OutcommingPacket(47, 4);
		ENTER_LONG_TEXT_PACKET = new OutcommingPacket(48, -1);
		PLAYER_OPTION_6_PACKET = new OutcommingPacket(49, 3);
		INTERFACE_ON_PLAYER = new OutcommingPacket(50, 11);
		PLAYER_OPTION_7_PACKET = new OutcommingPacket(51, 3);
		...
		ACTION_BUTTON_4_PACKET = new OutcommingPacket(55, 8);
		PLAYER_OPTION_9_PACKET = new OutcommingPacket(56, 3);
		ITEM_TAKE_PACKET = new OutcommingPacket(57, 7);
		MINI_WALKING_PACKET = new OutcommingPacket(58, -1);
		OBJECT_CLICK_2_PACKET = new OutcommingPacket(59, 9);
		DEVELOPER_CONSOLE_PACKET = new OutcommingPacket(60, -1);
		...
		NPC_CLICK_4_PACKET = new OutcommingPacket(65, 3);
		INTERFACE_ON_NPC = new OutcommingPacket(66, 11);
		ACTION_BUTTON_2_PACKET = new OutcommingPacket(67, 8);
		ACTION_BUTTON_5_PACKET = new OutcommingPacket(68, 8);
		aClass198_2062 = new OutcommingPacket(69, 15);
		WINDOW_FOCUS_PACKET = new OutcommingPacket(70, 1);
		GRAND_EXCHANGE_ITEM_SELECT = new OutcommingPacket(71, 2);
		...
		PLAYER_OPTION_5_PACKET = new OutcommingPacket(77, 3);
		aClass198_2011 = new OutcommingPacket(78, 1);
		LOBBY_FRIEND_CHAT_SETTINGS = new OutcommingPacket(79, 3);
		OBJECT_CLICK_5_PACKET = new OutcommingPacket(80, 9);
		ENTER_INTEGER_PACKET = new OutcommingPacket(81, 4);
		...
		WORLD_LIST_UPDATE = new OutcommingPacket(87, 4);
		aClass198_2064 = new OutcommingPacket(88, 3);
		ADD_FRIEND_PACKET = new OutcommingPacket(89, -1);
		ACTION_BUTTON_6_PACKET = new OutcommingPacket(90, 8);
		LOBBY_MAIN_CLICK_PACKET = new OutcommingPacket(91, -2);
		KICK_CLAN_CHAT_PACKET = new OutcommingPacket(92, -1);
		aClass198_2059 = new OutcommingPacket(93, -1);
		aClass198_1998 = new OutcommingPacket(94, 9);
		aClass198_2088 = new OutcommingPacket(95, -2);
		ACTION_BUTTON_10_PACKET = new OutcommingPacket(96, 8);
		...
		NPC_CLICK_2_PACKET = new OutcommingPacket(101, 3);
